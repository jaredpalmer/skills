# Why Isn't Especially Object-Oriented

![Why Isn't Especially Object-Oriented](https://s.turbifycdn.com/aah/paulgraham/why-arc-isn-t-especially-object-oriented-3.gif)
...
I personally have never needed object-oriented abstractions. Common has an enormously powerful object system and I've never used it once. I've done a lot of things (e.g. making hash tables full of closures) that would have required object-oriented techniques to do in wimpier languages, but I have never had to use CLOS.
